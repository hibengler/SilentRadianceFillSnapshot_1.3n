...
// ^ set in glue or on make - this makes up collect the bpg images for show 
...
int current_frame;  /* current frame being played (estimated) */
...
extern struct bpg_image *bpg_images[65536];

#define BPG_IMAGE_QUEUE_SIZE 10
extern unsigned short bpg_image_queue[BPG_IMAGE_QUEUE_SIZE];
extern int bpg_image_queue_head;
extern int bpg_image_queue_tail;

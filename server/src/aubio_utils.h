...
#define debug(...)
#endif
#define verbmsg(...)              if (APA(verbose)) fprintf (stderr, __VA_ARGS__)
...
#define debug(...)
#endif
#define verbmsg(format, args...)  if (APA(verbose)) fprintf(stderr, format , ##args)
...
typedef int (*aubio_process_func_t) (fmat_t * input, fvec_t * output);

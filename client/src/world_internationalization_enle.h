...
/* English american variation of Silent Radiance for LeLe */
...
// 
#define WORLD_Silent_Radiance "LeLe Radiance"
#define WORLD_Silent_Radiance_With_Version_Splash_Title "LeLe Radiance 1.3p"

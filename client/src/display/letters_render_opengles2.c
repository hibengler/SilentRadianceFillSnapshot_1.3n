...
void letters_opengles_setgraphics(GLuint xgProgram,
int xmColorHandle,GLuint xgvPositionHandle,GLuint xmPositionHandle) {
int i;
for (i=0;i<512;i++) {

...
int dennis1_setupGraphics(int w, int h,int graphics_type) {
...
void dennis1_renderBackground(int screen,glMatrix *eye) {
}
...
void dennis1_renderFrame(int screen,glMatrix *eye) {    
...
void dennis1_renderButton(int program,int mColorHandle,int menu_position_handle,glMatrix *MVPMatrix,int screen,glMatrix *eye) {
...
//#define WORLD_display_dennis1_Dennis1 "Dennis1"
      letters_out(lc,scale,x,y,0.f,WORLD_display_dennis1_Dennis1);
      }
    
}


void dennis1_renderForeground(int screen,glMatrix *eye) {
}



void dennis1_touchEvent(int action,float x,float y) {
if (action==1) {
  push_display_set(2);
  }
}
...
const display_set dennis1_display_set = {
  .name = "dennis1",
  .setupGraphics = dennis1_setupGraphics,
  .init = NULL,
  .finish = NULL,
  .changeScreen = NULL,
  .step = dennis1_step,
  .renderBackground = dennis1_renderBackground,
  .renderMain  = dennis1_renderFrame,
  .renderForeground = dennis1_renderForeground,
  .renderButton = dennis1_renderButton,
...
Revision 1.6  2019/04/15 08:13:56  hib
cleaning international

Revision 1.5  2019/03/17 12:58:24  hib
Updated copyrights

Revision 1.4  2019/03/14 12:47:55  hib
wip - working on makeing the store look good

Revision 1.3  2019/03/01 00:01:04  hib
...
dennis1 made from purple_string

...
#ifdef __APPLE__ 
/* Have to predefine the defined things here */
#define PLATFORM_SILENT_RADIANCE
...
typedef struct RenderTexture2D {
    ...
    #ifdef __APPLE__
    Texture2D color;       // color render buffer
    #endif
} RenderTexture2D;
...
#define MatrixIdentity rlMatrixIdentity

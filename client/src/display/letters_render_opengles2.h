...
extern unsigned int letters_opengles_color_handle(void);
extern unsigned int letters_opengles_program_handle(void);
extern unsigned int letters_opengles_position_handle(void);

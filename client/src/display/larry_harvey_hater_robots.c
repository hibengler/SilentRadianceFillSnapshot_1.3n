...
static float remember_beat_interval_in_milliseconds=-1.;
...
if (p->has_statistics) {
  if ((packet_summary.beat_interval_in_milliseconds>0)&&(packet_summary.beat_interval_in_milliseconds != 500000)) {
    if (remember_beat_interval_in_milliseconds >0) {
      remember_beat_interval_in_milliseconds = (remember_beat_interval_in_milliseconds *100.
	   + packet_summary.beat_interval_in_milliseconds) * one_over_101;;
      }
    else {
      remember_beat_interval_in_milliseconds = packet_summary.beat_interval_in_milliseconds;
      }
    }
...
if (last_sample_time.tv_sec==0) {
  ...
  long bigdiff=time_difference_in_milliseconds(packet_summary.current_sample_time,last_sample_time);
...
if (remember_beat_interval_in_milliseconds<=0) {
  ...
  angle +=  angle_sign * e.microseconds_passed / remember_beat_interval_in_milliseconds * angle_size;
  }
angle *= angle_reducer;

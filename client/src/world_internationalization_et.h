...
// kui vaatate seda, lubage mul teada, millised on valed ja parem korrektsioon
// Inglise nimi on koos WORLD kraamidega. Vene nimi on tsiteeritud.
// Mõlema kaldkriipsuga (//) sõnad aitavad teil teid juhendada.
...
// Rakenduse nimi. Alustatud kui Silent Radiance, kuid neil on erinevad nimed:
// Kiirgus inglise keeles nagu kuma, soojenemine
/ / Resplandor hispaania keeles - ka kuma
// tuntud ka kui "distantsdisko"
// Ükski neist ei näi töötavat. Ill kutsus seda "Radiance Estonia"
//
...
// None of them seem to work.  Ill call it "Radiance Estonia"
// 
#define WORLD_Silent_Radiance "Radiance Estonia"
#define WORLD_Silent_Radiance_With_Version_Splash_Title "Radiance Estonia 1.3o"

// WORLD_A_SilentRadiance_app - on vabatahtlik teine nimi, mis viitab silentradiance.com-le
// kasulik, kui rakenduse nimi on ümber nimetatud ja me tahame, et keegi peaks originaali tundma
// ei ole inglise keeles määratletud
//
...
// Mõned visualiseerijad tuvastavad, kas laul on 440 hz või 432 hz, ja paneb selle teksti üles, kui see on 432
//
...
// See on film, mis on tehtud armas robotitega, mis lähevad põlema mees ja toovad Larry Harvey surnuist tagasi
// Paha jumal Cthulhu tuleb põletusmehest põhja pool asuvasse kosmoselaevasse, elustab ja räägib Larryga oma uues roboti kehas.
// Larry Harvey on Burning Mani hiljuti vastu võetud asutaja.//
//
...
// Larry Harvey is the recently passed founder of Burning Man.
#define WORLD_Larry_qt_s_Possee_the_Robot_Haters "Larry posse: robotid, kes vihkavad"
...
#define WORLD_In_Rememberance_of "Mälestuses:"
#define WORLD_Larry_Harvey "Larry Harvey"

#define WORLD_UFOs_LAND_HERE__minus__gt_ "UFO, mis sisaldab Cthulhu maad siin ->"

#define WORLD_Larry_comma__thanks_for_Burning_Man "Larry, tänu Burning Manile"

#define WORLD_And_comma__well_comma__thats_about_it "ja hästi, see on sellest."
#define WORLD_We_came_to_be_because_of_you "Me tulime teie pärast"
#define WORLD_And_brought_you_here "ja tõin teid siia"
#define WORLD_All_of_the_good_times_you "Kõik head ajad, mida te "
#define WORLD_keep_dot__Take_this_letter "hoiate. Võtke see kiri"
#define WORLD_Thats_all_you_get "See kõik on"
#define WORLD_Now_comma__lets_burn_something_excl_ "Nüüd põletame midagi!"


// Järgmisena tulevad visualiseerijate nupud
//
...
#define WORLD_display_visual_voice__Sing "laula" 
#define WORLD_display_visual_voice_Along "kaasa"

// Aknapood, - vaadake, mis mängib, ja ka seda, mis mängis, ja ostke laulu või muid asju
//  Mõnikord on aknapoodi asemel Window Show, kui muusika on tasuta.
//
// Window shop, - look at what is playing and also what was playing, and buy the song, or other stuff
//  Sometimes Window Show instead of Window Shop, when the music is free.
#define WORLD_display_window_shop_Window "Akna"
#define WORLD_display_window_shop__dlr_hop "ostmine"
#define WORLD_display_window_shop_Show "näidata"


//
// Ostke nüüd - ei ole ülevaadet ning võtab isiku tasuliseks laulu ostmiseks kohe - kui laul on nii hea.
// Mõnikord on laul nüüd tasuta, kui laul on tasuta.
// Igal võistlusel on $ $ $ - dollari märkide (või rubla või euro jne) välk.
//
...
#define WORLD_display_buy_it_now_Buy "Osta"
#define WORLD_display_buy_it_now_Get "saada"
#define WORLD_display_buy_it_now_Now "nüüd"
// instead of kohe
...
// Virtuaalne reaalsus on teine nupp 
//
// Virtual Reality is another button.
#define WORLD_display_main_menu_Virtual "Virtuaalne"
#define WORLD_display_main_menu_Reality "Reaalsus"

// See on visualiseerija nimi, mis näitab muusika märkmeid

//
// This is the name of a visualizer that shows the music notes
#define WORLD_display_staff_staff "noodid"
...
// See on Reggaeton Puerto Ricost
//
// This is Reggaeton from Puerto Rico
#define WORLD_display_top_menu_Rge "Reggaeton"


// Mõned visuaalsed pildid näitavad praegust märkust. Need on muusikateated, mis algavad numbriga A
//
// Some visuals will show the current note being played. These are music notes starting with A
#define WORLD_display_staff_A "A"
#define WORLD_display_staff_Bb "B korter"
...
#define WORLD_display_staff_Eb "E korter"
...
#define WORLD_display_staff_Ab "A korter"
...
#define WORLD_GPS_WARNING "Sa peaksid määrama asukoharežiimi ainult GPS-i aktiivsuseks\n\nMiks?\n\n I nAku salvestamine ja suure täpsusega režiimid kasutavad wifi-d.\nSee põhjustab muusika mõne sekundi vältel väljavõtmise.\n\n sest paljud seadmed vaatavad wifi-i isegi siis, kui asukoht on välja lülitatud.\nMõned telefonid töötavad hästi sõltumata n nSentent Radiance ei kasuta teie asukohta"

//#define WORLD_GPS_GOTO_THE_SETTINGS = "Go to the Settings"
#define WORLD_GPS_GOTO_THE_SETTINGS = "Avage seaded"

//#define WORLD_GPS_ILL_TAKE_MY_CHANCES = "I'll take my chances"
#define WORLD_GPS_ILL_TAKE_MY_CHANCES = "Ma võtan oma võimalused"
...
// Ülejäänud on tehnilisem - tavaliselt ignoreeritakse
//

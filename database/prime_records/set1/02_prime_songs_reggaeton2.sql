...
select 'reggaeton2.silentradiance.com','GLADIAT','Prime','GLADIAT'
...
select 'reggaeton2.silentradiance.com','GLADIAT','2','La Caza Bichotes','La Caza Bichotes' 
...
select 'reggaeton2.silentradiance.com','GLADIAT','2',1,'Main',(select artist_id from sr_artists where artist_code= 'Farruko' ) 
where not exists(select 1 from sr_cd_track_artists where station_name = 'reggaeton2.silentradiance.com' 
...
insert into sr_cd_track_artists(station_name,cd_short_name,track,sequence,type,artist_id)
select 'reggaeton2.silentradiance.com','GLADIAT','2',2,'Main',(select artist_id from sr_artists where artist_code= 'Benny Benni' ) 
where not exists(select 1 from sr_cd_track_artists where station_name = 'reggaeton2.silentradiance.com' 
...
where station_name='reggaeton2.silentradiance.com' and cd_short_name='pricd001';
...
where station_name='reggaeton2.silentradiance.com' and cd_short_name='pricd002';
update sr_cds set  imagehead_url=null,image_url='Prime_Records/pricd003-DJ_Negro_and_Vico_C-La_Recta_Final/front_cover.png'  
where station_name='reggaeton2.silentradiance.com' and cd_short_name='pricd003';
...
where station_name='reggaeton2.silentradiance.com' and cd_short_name='pricd004';
update sr_cds set  imagehead_url=null,image_url='Prime_Records/pricd004-Various-Prime_Underground_3_Explicit/front_cover.png'  
where station_name='reggaeton2.silentradiance.com' and cd_short_name='pricd004';

 update sr_cds set  imagehead_url=null,image_url='Prime_Records/pricd005-Vico_C-Greatest_Hits_Explicit/front_cover.png'  
 where station_name='reggaeton2.silentradiance.com' and cd_short_name='pricd005';
...
where station_name='reggaeton2.silentradiance.com' and cd_short_name='pricd010';
